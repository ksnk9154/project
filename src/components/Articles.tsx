    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-black max-w-3xl mx-auto">
          Explore profound insights into Sanatana Dharma, Vedanta, and the timeless wisdom of Hindu philosophy through teachings by Dr. Aravinda Rao Karanam
        </p>
      </div>
      ...
      <div className="mt-12 p-8 bg-gradient-to-r from-orange-100/80 to-amber-100/80 border-l-4 border-orange-500 rounded-lg shadow-md">
        ...
        <p className="text-black italic">
          — Ancient Hindu wisdom, as taught by Dr. Aravinda Rao Karanam
        </p>
      </div>
