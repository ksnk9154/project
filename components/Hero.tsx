import ganeshaImage from "figma:asset/938f4d9c153ed0e2dace62f9275d2003abad713c.png";
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-amber-800 leading-relaxed">
              Discover the profound wisdom of Non-duality
              through the teachings of Dr. Karanam Aravinda Rao
            </p>
